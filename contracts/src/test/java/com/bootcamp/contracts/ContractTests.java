...
public class ContractTests {
    ...
    private TokenState tokenState = new TokenState(alice.getParty(), bob.getParty(), 1, "USD");
    ...
    public void tokenContractRequiresTheTransactionsOutputToHaveAPositiveAmount() {
        TokenState zeroTokenState = new TokenState(alice.getParty(), bob.getParty(), 0, "USD");
        TokenState negativeTokenState = new TokenState(alice.getParty(), bob.getParty(), -1, "USD");
        TokenState positiveTokenState = new TokenState(alice.getParty(), bob.getParty(), 2, "USD");
    ...
    public void tokenContractRequiresTheIssuerToBeARequiredSignerInTheTransaction() {
        TokenState tokenStateWhereBobIsIssuer = new TokenState(bob.getParty(), alice.getParty(), 1, "USD");
